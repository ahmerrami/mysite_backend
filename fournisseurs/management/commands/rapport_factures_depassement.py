...
# -*- coding: utf-8 -*-
"""
Commande Django: Génère et envoie le rapport des factures dépassement d'échéance.
"""
from django.core.management.base import BaseCommand
from django.conf import settings
from utils.emails import generer_et_envoyer_factures_depassement_fournisseurs


class Command(BaseCommand):
    help = "Génère et envoie le rapport des factures dépassement d'échéance par email"

    def handle(self, *args, **options):
        try:
            sent_count = generer_et_envoyer_factures_depassement_fournisseurs()
        ...
        self.stdout.write(self.style.SUCCESS(f"Le rapport factures depassement a ete envoye ({sent_count} email)."))
